...
SWIG_MAIN = jni/selfcamera.i

SWIG_JAVA_DIR = src/com/nekomeshi312/selfcamera/jni
SWIG_JAVA_OUT = $(wildcard $(SWIG_JAVA_DIR)/*.java)


SWIG_C_DIR = jni/gen
SWIG_C_OUT = $(SWIG_C_DIR)/selfcamera_swig.cpp
...
$(SWIG_C_OUT): $(SWIG_IS)
	...
	swig -java -c++ -I../../android-jni/jni -package  "com.nekomeshi312.selfcamera.jni" \
